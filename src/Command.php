...
class Command extends Component
{
     ...
     * @param null $dependency                               the cache dependency associated with the cached query result.
     *
    ...
    {
        \Hyperf\Retry\Retry::with(new \Hyperf\Retry\Policy\ClassifierRetryPolicy())->max(3)->inSeconds(5)->sleep(1)->call(function () use ($rawSql) {
            $attempt = 0;
            while (true) {
                try {
