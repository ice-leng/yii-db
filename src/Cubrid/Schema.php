...
namespace Lengbin\YiiDb\Cubrid;
 ...
 * @since 2.0
 */
class Schema extends \Lengbin\YiiDb\Schema implements ConstraintFinderInterface
{
     ...
     * @return \Lengbin\YiiDb\ColumnSchema the column schema object
     */
