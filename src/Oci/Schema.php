...
namespace Lengbin\YiiDb\Oci;

use Lengbin\Helper\YiiSoft\Arrays\ArrayHelper;
use Lengbin\YiiDb\Constraint;
use Lengbin\YiiDb\Exception\InvalidCallException;
use Lengbin\YiiDb\CheckConstraint;
use Lengbin\YiiDb\ColumnSchema;
...
class Schema extends \Lengbin\YiiDb\Schema implements \Lengbin\YiiDb\ConstraintFinderInterface
{
     ...
     */
    public $exceptionMap = [
        'ORA-00001: unique constraint' => '\Lengbin\YiiDb\Exception\IntegrityException',
    ];
...
SQL;
     ...
     * @internal param \Lengbin\YiiDb\TableSchema $table->name the table schema
