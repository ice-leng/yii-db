...
class Validator
{
    ...
    public static $builtInValidators = [
        'boolean' => 'Lengbin\YiiDb\Validators\BooleanValidator',
        'compare' => 'Lengbin\YiiDb\Validators\CompareValidator',
        'date' => 'Lengbin\YiiDb\Validators\DateValidator',
        'datetime' => [
            'class' => 'Lengbin\YiiDb\Validators\DateValidator',
        ...
        'default' => 'Lengbin\YiiDb\Validators\DefaultValueValidator',
        'double' => 'Lengbin\YiiDb\Validators\NumberValidator',
        'each' => 'Lengbin\YiiDb\Validators\EachValidator',
        'email' => 'Lengbin\YiiDb\Validators\EmailValidator',
        'exist' => 'Lengbin\YiiDb\Validators\ExistValidator',
        'filter' => 'Lengbin\YiiDb\Validators\FilterValidator',
        'in' => 'Lengbin\YiiDb\Validators\RangeValidator',
        'integer' => [
            'class' => 'Lengbin\YiiDb\Validators\NumberValidator',
            'integerOnly' => true,
        ],
        'match' => 'Lengbin\YiiDb\Validators\RegularExpressionValidator',
        'number' => 'Lengbin\YiiDb\Validators\NumberValidator',
        'required' => 'Lengbin\YiiDb\Validators\RequiredValidator',
        'safe' => 'Lengbin\YiiDb\Validators\SafeValidator',
        'string' => 'Lengbin\YiiDb\Validators\StringValidator',
        'trim' => [
            'class' => 'Lengbin\YiiDb\Validators\FilterValidator',
            'filter' => 'trim',
            'skipOnArray' => true,
        ],
     ...
     * @param bool$isTranslate is translate
     * @return Validator the validator
     */
    public static function createValidator($type, $model, $attributes, $params = [], $isTranslate = true)
    {
        $params['attributes'] = $attributes;
        $params['isTranslate'] = $isTranslate;
    ...
    public function init()
    {
        ...
        $this->translate = require __DIR__ . '/message.php';
    }
     ...
     *     return [$this->message, [
     *         'param1' => $this->param1,
     *         'formattedLimit' => Yii::$app->formatter->($this->getSizeLimit()),
    ...
    {
        if ($this->isTranslate && isset($this->translate[$message])) {
