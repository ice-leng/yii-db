...
class QueryBuilder extends \Lengbin\YiiDb\QueryBuilder
{
    ...
    protected function defaultConditionClasses()
    {
        return array_merge(parent::defaultConditionClasses(), [
            'ILIKE' => 'Lengbin\YiiDb\conditions\LikeCondition',
            'NOT ILIKE' => 'Lengbin\YiiDb\conditions\LikeCondition',
            'OR ILIKE' => 'Lengbin\YiiDb\conditions\LikeCondition',
            'OR NOT ILIKE' => 'Lengbin\YiiDb\conditions\LikeCondition',
        ]);
    }
    ...
    protected function defaultExpressionBuilders()
    {
        return array_merge(parent::defaultExpressionBuilders(), [
            'Lengbin\YiiDb\ArrayExpression' => 'Lengbin\YiiDb\pgsql\ArrayExpressionBuilder',
            'Lengbin\YiiDb\JsonExpression' => 'Lengbin\YiiDb\pgsql\JsonExpressionBuilder',
        ]);
    }
     ...
     * of [[Lengbin\YiiDb\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     * Passing of [[Lengbin\YiiDb\Query|Query]] is available since version 2.0.11.
